    ...
    <div class="col-12 sale-order-detail-general">
        ...
        <div class="row sale-order-detail-about-order">
            ...
            <div class="col-12 sale-order-detail-about-order-container">
                <div class="order-message">Состав Вашего заказа изменился. Внимательно проверьте наличие и цены обновленного состава заказа. Если у Вас возникли вопросы, свяжитесь с менеджером</div>
                <div class="row">
                                ...
                                <div class="sale-order-detail-order-table-fade sale-order-detail-order-table-fade-right">
                                    <div style="width: 100%; overflow-x: auto; overflow-y: hidden;">
                                        <div class="sale-order-detail-order-item-table">
                                            ...
                                            {
                                            ?>
                                            <div class="sale-order-detail-order-item-tr sale-order-detail-order-basket-info sale-order-detail-order-item-tr-first disabled">
                                                <div class="sale-order-detail-order-item-td">
                                                    <div class="sale-order-detail-order-item-block">
            ...
            <div class="col-12 sale-order-detail-total-payment-container">
                <div class="row">
                    <ul class="col-md-9 col-7 sale-order-detail-total-payment-list-left">
                        ...
                        <li class="sale-order-detail-total-payment-list-left-item">Итого с учетом перерасчета:</li>
                    </ul>
                    <ul class="col-md-3 col-5 sale-order-detail-total-payment-list-right">
                        ...
                        <li class="sale-order-detail-total-payment-list-left-item">24 000 ₽</li>
                    </ul>
                </div>
            </div>
        </div>
