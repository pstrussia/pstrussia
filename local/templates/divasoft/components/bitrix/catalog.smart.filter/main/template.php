        ...
        <div class="body content-animate-slide-down <?= $arParams["TAB_FILTER"] ?> noactive-mob" data-show = "<?= $arParams["DATA_SHOW"] ?>" style='display:<?= ($arParams["TAB_FILTER"] == 'active') ? 'block' : '' ?>'>
            ...
            <div class="bx-filter">
                <div class="bx-filter-section">
                    ...
                    <form name="<? echo $arResult["FILTER_NAME"] . "_form" ?>" action="<? echo $arResult["FORM_ACTION"] ?>" method="get" class="smartfilter <?= ($PHOENIX_TEMPLATE_ARRAY["ITEMS"]["FOOTER"]["ITEMS"]["FOOTER_ON"]["VALUE"]["ACTIVE"] === "Y") ? '' : 'max-height' ?>">
                        ...
                        <? if (!empty($arResult["ITEMS"])): ?>
                            ...
                            <?
                            if ($arParams["FILTER_HIDE_PRICE"] != "Y") {
                                        ...
                                        <div class="row no-margin bx-filter-parameters-box-container">
                                            ...
                                            switch ($arItem["DISPLAY_TYPE"]) {
                                                ...
                                                case "P"://DROPDOWN
                                                    ...
                                                    ?>
                                                    <div class="col-12">
                                                        <div class="bx-filter-select-container bx_filter_select_container">
                                                            <div class="bx-filter-select-block" onclick="smartFilter.showDropDownPopup(this, '<?= CUtil::JSEscape($key) ?>')">
                                                                <div class="bx-filter-select-text bx_filter_select_text" data-role="currentOption">
                                                                    <?
                                                                    foreach ($arItem["VALUES"] as $val => $ar) {
                                                                        if ($ar["CHECKED"]) {
                                                                            echo $ar["VALUE"];
                                                ...
                                                case "K"://RADIO_BUTTONS
                                                    ...
                                                    <div class="col-12 <?= $arrClassesItemValue["PARENT"] ?>">
                                                                            ...
                                                                            <span class="bx-filter-input-checkbox <? echo $ar["DISABLED"] ? 'disabled' : '' ?>">
                                                                                ...
                                                                                <span class="bx-filter-param-text text" title="<?= $ar["VALUE"]; ?>"><?= $ar["VALUE"]; ?><?
                                                                                    if ($arParams["DISPLAY_ELEMENT_COUNT"] !== "N" && isset($ar["ELEMENT_COUNT"])):
                                                                                        ?>&nbsp;<span class="count">(<span data-role="count_<?= $ar["CONTROL_ID"] ?>"><? echo $ar["ELEMENT_COUNT"]; ?></span>)</span><? endif;
                                                                                    ?></span>
                                                                            </span>
                                                                        </label>
                                                                    </li>
                                                        ...
                                                        <? if ($countItem > 5 && strlen($arrClassesItemValue["HIDDEN"]) > 0): ?>
