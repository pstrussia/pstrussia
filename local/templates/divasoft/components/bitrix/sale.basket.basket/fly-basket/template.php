                ...
                <tbody>
                    <tr>
                        ...
                        <? if (isset($par_condition)): ?>
                            <td class="right">
                                <a <?= $par_condition ?>><span class="bord-bot"><?
                                        if (strlen($PHOENIX_TEMPLATE_ARRAY["ITEMS"]["SHOP"]["ITEMS"]['CART_BTN_NAME_CONDITIONS']["VALUE"]) > 0)
                                            echo $PHOENIX_TEMPLATE_ARRAY["ITEMS"]["SHOP"]["ITEMS"]['CART_BTN_NAME_CONDITIONS']["VALUE"];
                                        else
                                            echo $PHOENIX_TEMPLATE_ARRAY["MESS"]["CART_DELIVERY"];
                                        ?></span></a>
                            </td>
                        <? endif; ?>
                    </tr>
                ...
                <table class="mobile-break">
                    <tbody>
                        <tr>
                            ...
                            <? if (isset($par_condition)): ?>
                                <td class="right">
                                    <a <?= $par_condition ?>><span class="bord"><?
                                            if (strlen($PHOENIX_TEMPLATE_ARRAY["ITEMS"]["SHOP"]["ITEMS"]['CART_BTN_NAME_CONDITIONS']["VALUE"]) > 0)
                                                echo $PHOENIX_TEMPLATE_ARRAY["ITEMS"]["SHOP"]["ITEMS"]['CART_BTN_NAME_CONDITIONS']["VALUE"];
                                            else
                                                echo $PHOENIX_TEMPLATE_ARRAY["MESS"]["CART_DELIVERY"];
