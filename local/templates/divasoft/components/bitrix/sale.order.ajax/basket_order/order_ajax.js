...
(function() {
	...
	BX.Sale.OrderAjaxComponent = {
		...
		getDeliveryLocationInput: function(node)
		{
			...
			if (location && location[0] && location[0].output)
			{
				...
				labelHtml = '<div class="section-title">'
					+ '<span class="text">'+currentProperty.NAME + '</span>'
		...
		getZipLocationInput: function(node)
		{
			...
			if (zipProperty)
			{
				if(!this.regionBlockNotEmpty && this.showZip == "Y")
				{
					this.regionBlockNotEmpty = true;
				}
		...
		editDeliveryInfo: function(deliveryNode)
		{
			...
			deliveryInfoContainer.appendChild(
				BX.create('DIV', {
					props: {className: 'bx-soa-pp-company order-delivery-item-info delivery-id-'+currentDelivery.ID+''},
					children: [box1, box2]
				})
			);
		...
		editTotalBlock: function()
		{
			...
			tmpHTML = "<div class=\"item row no-gutters no-margin side-sum-row\">"
			...
			{
				tmpHTML += "<div class=\"item row no-gutters no-margin discount-row\">"
			...
			if(curDelivery)
			{
				...
				tmpHTML += "<div class=\"item row no-gutters no-margin delivery-row\">"
			...
			{
				tmpHTML += "<div class=\"item row no-gutters no-margin sum-it-row\">"
				...
				tmpHTML += "<div class=\"item row no-gutters no-margin sum-payed-row\">"
			...
			if(this.minSumValue)
			{
				if(this.minSumValue <= total.ORDER_PRICE)
				{
					...
					$("#bx-soa-order").removeClass('d-none');
				}
