...
<div class="item-inner">
    ...
    <div class="wrapper-bot part-hidden">
        ...
        <?
        if ($arItem['HAVEOFFERS'] || strlen($arItem["FIRST_ITEM"]["SHORT_DESCRIPTION"]) || strlen($arItem["FIRST_ITEM"]["PREVIEW_TEXT"]) || !empty($arItem["CHARS_SORT"]) || $PHOENIX_TEMPLATE_ARRAY["ITEMS"]["RATING"]["ITEMS"]["USE_VOTE"]["VALUE"]["ACTIVE"] == "Y"
        ):
            ?>
