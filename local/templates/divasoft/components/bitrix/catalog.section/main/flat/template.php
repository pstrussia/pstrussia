                                                ...
                                                <ul class="sku-props clearfix">
                                                    ...
                                                    <? if (!empty($skuProperty['VALUES'])) : ?>
                                                        ...
                                                        <? foreach ($skuProperty['VALUES'] as $value) : ?>
                                                            ...
                                                            <li title='<?= CPhoenix::prepareText($value['NAME']) ?>' class="detail-color" data-treevalue="<?= $propertyId ?>_<?= $value['ID'] ?>" data-onevalue="<?= $value['ID'] ?>">
                                                ...
                                                <div class="wrapper-select-input">
                                                    ...
                                                    <ul class="sku-props select-input">
                                                        ...
                                                        <? if (!empty($skuProperty['VALUES'])) : ?>
                                                            ...
                                                            <? foreach ($skuProperty['VALUES'] as $value) : ?>
                                                                <li title='<?= CPhoenix::prepareText($value['NAME']) ?>' data-treevalue="<?= $propertyId ?>_<?= $value['ID'] ?>" data-onevalue="<?= $value['ID'] ?>"><?= $value['NAME'] ?></li>
                                                            <? endforeach; ?>
                                            ...
                                            <? else : ?>
                                                ...
                                                <ul class="sku-props">
                                                    ...
                                                    <? if (!empty($skuProperty['VALUES'])) : ?>
                                                        ...
                                                        <? foreach ($skuProperty['VALUES'] as &$value) : ?>
                                                            <li title='<?= CPhoenix::prepareText($value['NAME']) ?>' class="detail-text" data-treevalue="<?= $propertyId ?>_<?= $value['ID'] ?>" data-onevalue="<?= $value['ID'] ?>"><?= $value['NAME'] ?></li>
                                                        <? endforeach; ?>
            ...
            <div class="wrapper-inner-bot row no-gutters <? if ($arItem['QUANTITY']['QUANTITY_VALUE'] > '0') { ?> hidden-js.active<? } else { ?> hidden-js <? } ?>" id="<?= $itemIds['WR_ADD2BASKET'] ?>">
                ...
                <div class="btn-container align-items-center col-xl-6 col-12" id="<?= $itemIds['BASKET_ACTIONS'] ?>">
                    ...
                    <div class="<?= ($arItem['HAVEOFFERS']) ? " d-lg-block" : "" ?>">
                        <a id="<?= $itemIds['ADD2BASKET'] ?>" href="javascript:void(0);" data-item="<?= $arItem["ID"] ?>" class="main-color add2basket bold"><?= $PHOENIX_TEMPLATE_ARRAY["ITEMS"]["SHOP"]["ITEMS"]["CART_BTN_ADD_NAME"]["~VALUE"] ?></a>

                        <a id="<?= $itemIds['MOVE2BASKET'] ?>" href="<?= $PHOENIX_TEMPLATE_ARRAY["ITEMS"]["SHOP"]["ITEMS"]["BASKET_URL"]["VALUE"] ?>" data-item="<?= $arItem["ID"] ?>" class="move2basket"><?= $PHOENIX_TEMPLATE_ARRAY["ITEMS"]["SHOP"]["ITEMS"]["CART_BTN_ADDED_NAME"]["~VALUE"] ?></a>
                    </div>
