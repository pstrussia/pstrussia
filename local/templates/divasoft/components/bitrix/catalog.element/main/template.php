    ...
    <div id="<?= $itemIds['ID'] ?>" class="catalog-item">
        ...
        <div class="row">
            <div class="col-xl-7 col-sm-6 col-12 info-left-side wrapper-delay-compare-icons-parent">
                ...
                if (
                        $PHOENIX_TEMPLATE_ARRAY["ITEMS"]["CATALOG"]["ITEMS"]['USE_BTN_SCROLL2CHARS']["VALUE"]["ACTIVE"] == "Y" && (!empty($arResult['PRODUCT']["CHARS_SORT"]) || !empty($arResult["PRODUCT"]["FILES"])) && $arResult["PRODUCT"]["SCROLL_TO_CHARS_OFF"] != "Y"
                )
                ...
                <? if ($arResult['PRODUCT']['CONFIG']['SHOW_DELAY'] == "Y" || $arResult['PRODUCT']['CONFIG']['SHOW_COMPARE'] == "Y"):
                    ?>
            ...
            <div class="col-xl-5 col-sm-6 col-12 info-right-side <?= ($arResult['PRODUCT']['CONFIG']['SHOW_PRICE_SIDE']) ? '' : 'd-none'; ?>">
                ...
                <div class="info-right-side-inner">
                    ...
                    <div class="wrapper-price-sku-props" id="actual_price">
                            ...
                            <div class="wrapper-quantity-total row no-gutters align-items-center">
                                <div class="col-md-6 col-sm-12">
                                    <div class="quantity-container row no-gutters align-items-center justify-content-between">
                                        <span class="product-item-amount-field-btn-minus"  onclick="setQuantity(<?=$itemIds['QUANTITY']?>, 1, 'down', false,true);">&minus;</span>
                                        <input class="product-item-amount-field" id="<?= $itemIds['QUANTITY'] ?>" type="number"
                                               value="<?= $arResult["FIRST_ITEM"]["PRICE"]["MIN_QUANTITY"] ?>" onchange="updateQuantity()">
                                        <span class="product-item-amount-field-btn-plus" onclick="setQuantity(<?=$itemIds['QUANTITY']?>, 1, 'up', false,true);">&plus;</span>
                                    </div>
                                </div>
                                <script>
                        ...
                        <?if($arResult["FIRST_ITEM"]["QUANTITY"]['QUANTITY_VALUE'] != 0 && $arResult["FIRST_ITEM"]['PRICE']['PRICE'] != -1):?>
