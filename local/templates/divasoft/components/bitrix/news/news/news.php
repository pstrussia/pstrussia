...
<?
	...
	if(strlen($PHOENIX_TEMPLATE_ARRAY["ITEMS"][$arParams["ARRAY_NAME"]]["ITEMS"]["BG_PIC"]["VALUE"])>0)
		$header_back = CFile::ResizeImageGet($PHOENIX_TEMPLATE_ARRAY["ITEMS"][$arParams["ARRAY_NAME"]]["ITEMS"]["BG_PIC"]["VALUE"], array('width'=>3000, 'height'=>1500), BX_RESIZE_IMAGE_PROPORTIONAL, false);
	                		...
	                		<div class="selector-fixedSrollBlock menu-navigation" id='navigation'>
	                			<div class="selector-fixedSrollBlock-real-height menu-navigation-inner">
	                				...
	                				<div class="for-sidemenu-mobile">
		                                ...
		                                <?if(strlen($PHOENIX_TEMPLATE_ARRAY["ITEMS"][$arParams["ARRAY_NAME"]]["ITEMS"]["SIDE_MENU_HTML"]["VALUE"])>0):?>
		                                    <div class="sidemenuHTML"><?=$PHOENIX_TEMPLATE_ARRAY["ITEMS"][$arParams["ARRAY_NAME"]]["ITEMS"]["SIDE_MENU_HTML"]["~VALUE"]?></div>
		                                <?endif;?>
