...
$frame = $this->createFrame()->begin();?>
	...
	<?if(!empty($arResult['ITEMS'])):?>
		...
		<div class="gifts-block">
			...
			<div class="gifts-block-title"><?=$PHOENIX_TEMPLATE_ARRAY["MESS"]["BASKET_GIFTS_TITLE"]?></div>
			...
			<div class="row">
				<?foreach ($arResult['ITEMS'] as $key => $arItem):?>
					...
					?>
					<div class="col-md-4 wr-gift-item" id="<?=$itemIds['ID']?>">
						<div class="gift-item gift-item-js">
							<div class="row">
								<a href="<?=$arItem['FIRST_ITEM']['DETAIL_PAGE_URL']?>" class="col-4 gift-item-img-link-js">
									<div class="gift-item-wr-img">
										<img class="gift-item-img gift-item-img-js lazyload" src="<?=$arItem["FIRST_ITEM"]["PHOTO"]?>" alt="<?=$arItem["ALT"]?>">
									</div>
								</a>
								<div class="col-8 gift-item-wr-price">
									<div class="gift-item-price gift-item-price-js" title="<?=$arItem["FIRST_ITEM"]['PRICE']['PRINT_VALUE']?>">
										<?=$arItem["FIRST_ITEM"]['PRICE']['PRINT_VALUE']?>
									</div>
									<div class="gift-item-actual-price"><?=$arItem["FIRST_ITEM"]['PRICE']['PRINT_DISCOUNT_VALUE']?></div>
								</div>
							</div>
							<a class="gift-item-name gift-item-name-js" href="<?=$arItem['FIRST_ITEM']['DETAIL_PAGE_URL']?>"><?=$arItem["NAME_HTML"]?></a>

							<div class="gift-hidden-container">

								<?if($arItem['CONFIG']["SHOW_OFFERS"] && !empty($arItem["SKU_PROPS"])):?>

									<div class="sku-container sku-container-js d-block">
										...
										<?foreach ($arItem["SKU_PROPS"] as $skuProperty):?>
		                                    ...
		                                    <div class="wr-sku-props">

                                                <div class="sku-prop-title"><?=htmlspecialcharsEx($skuProperty['NAME'])?><span class="prop-name"></span> </div>
	                                            ...
	                                            <?if ($PHOENIX_TEMPLATE_ARRAY["ITEMS"]["CATALOG"]["ITEMS"]['OFFER_FIELDS']["VALUES"][$skuProperty["ID"]]["VALUE_2"] == 'pic' || $PHOENIX_TEMPLATE_ARRAY["ITEMS"]["CATALOG"]["ITEMS"]['OFFER_FIELDS']["VALUES"][$skuProperty["ID"]]["VALUE_2"] == 'pic_with_info'):?>
	                                                ...
	                                                <ul class="sku-props clearfix">
	                                                    ...
	                                                    <?foreach ($skuProperty['VALUES'] as $value):?>
	                                                        ...
	                                                        <li title='<?=CPhoenix::prepareText($value['NAME'])?>' class="detail-color detail-color-small"
	                                            ...
	                                            <?elseif($PHOENIX_TEMPLATE_ARRAY["ITEMS"]["CATALOG"]["ITEMS"]['OFFER_FIELDS']["VALUES"][$skuProperty["ID"]]["VALUE_2"] == 'select'):?>
	                                                ...
	                                                <div class="wrapper-select-input sku-props-select-small">
								...
								<?endif;?>
								<div class="gift-item-wr-btn d-block">
									<a class="main-color button-def round-sq d-block gift-item-btn gift-item-btn-js" href="javascript:void(0)"><?=$PHOENIX_TEMPLATE_ARRAY["MESS"]["BASKET_GIFTS_BTN_NAME"]?></a>
								</div>
							</div>
						</div>
					</div>
