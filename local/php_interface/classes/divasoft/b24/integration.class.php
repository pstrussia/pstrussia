...
class integrationB24 {
	...
	public static function vikup ($arFields = []) {
		...
		/*$arFields['NAME'] = 'Имя';
		$arFields['CODE'] = 'Марка модель год';
		$arFields['TELEPHONE'] = '790999934234';
		$arFields['MAIL'] = '7909312342342@ya.ru';
		$arFields['CITY'] = 'Пенза';
		
		$arFields['DESCRIPTION'] = 'Описание неисправности';
		$arFields['DOC'] = "/upload/iblock/9e8/ligt9ukrfzaytimxkpsw4p6gugrwt0rx.jpg";*/
		...
		$fieldsDeal['UF_CRM_1658906618090'] = 622;//вид формым 620 - уточнить наличие или 622 - выкуп рейки
	...
	public static function nalishie ($arFields = []) {
		...
		/*$arFields['NAME'] = 'Сергей';
		$arFields['HEADER'] = 'Детальная страница товара, кнопка "Под заказ"';
		$arFields['PHONE'] = '790999934234';
		$arFields['EMAIL'] = '7909312342342@ya.ru';
		$arFields['TEXT'] = 'Проверка';
		$arFields['URL'] = "http://bitrix.gur58.beget.tech/catalog/detail/bachok-gur-chevrolet-cruze-opel-astra-j/";*/
		...
		$fieldsDeal['UF_CRM_1658906618090'] = 620;//вид формым 620 - уточнить наличие или 622 - выкуп рейки
